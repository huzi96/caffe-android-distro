...
extern int __run(int argc, char *argv[]);
...
int simple_train(char *solver_path)
{
...
extern int __run(int argc, char* argv[]) {
  ...
  LOG(INFO) << ("Flag");
  simple_train("/storage/emulated/0/mnist/lenet_solver.prototxt");
  return 0;
    ...
    LOG(INFO) << "Function __run has run";
  }
  return 0;
}
